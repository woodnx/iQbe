...
import { ActionIcon, Button, Center, CopyButton, Modal, Stack } from '@mantine/core';
...
export default function InviteCodeCreateModal({

}: InviteCodeCreateModalProps) {
  const [ opened, { open, close } ] = useDisclosure();
  const [ enabled, setEnabled ] = useState(false);
  const { data } = $api.useQuery('post', '/invite-code', {}, {
    enabled
  });
