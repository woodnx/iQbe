...
export const typedWrapper = <Path extends ApiPath, Method extends HttpMethod> (
  handler: (
  ...
  req: express.Request<ApiQueryParam<Path, Method>, any, ApiBody<Path, Method>, ApiPathParam<Path, Method>>, 
